...
npa_classifications = np.loadtxt("classifications/classifications.txt", np.float32)
npa_flattenedImages = np.loadtxt("classifications/flattened_images.txt", np.float32)
# create KNN object
...
# load plate image
img = cv2.imread('results/plate.jpg')
# apply a blur to make edges thick
img = cv2.GaussianBlur(img, (5, 5), 0)
# convert image to grayscale
gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
# apply a threshold to make image black & white
