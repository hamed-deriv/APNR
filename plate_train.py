...
def main():
    ...
    for char in valid_chars:
        if char in glyphs.keys():
            ...
            font = ImageFont.truetype('glyphs/b_roya_bold.ttf', 40)
        ...
        image_thresh = cv2.adaptiveThreshold(image_gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV, 11, 2)
